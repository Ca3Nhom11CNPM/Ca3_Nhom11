                ...
                <div class="col-lg-9 col-12 order-1 order-lg-2">
                    ...
                    <div class="tab__container">
                        ...
                        <div class="shop-grid tab-pane fade show active" id="nav-grid" role="tabpanel">
                                    ...
                                    <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="product__content content--center">
                                            ...
                                            <ul class="prize d-flex">
                                                <li><%=p.getString(3)%> ₫</li>
                                                <%--												<li class="old_prize"><%=p.getDouble(3)%></li>--%>
                                            </ul>
                                            <div class="action">
                                                <div class="actions_inner">
                                                    <ul class="add_to_links">
                                                        <li><a class="cart" href="<%=Util.fullPath("ShowCart")%>" title="Giỏ hàng"><i class="bi bi-shopping-bag4"></i></a></li>
                                                        <li><a class="wishlist" href="<%= Util.fullPath("AddNXB?id="+p.getInt(1))%>" title="Thêm vào giỏ hàng"><i class="bi bi-shopping-cart-full"></i></a></li>
                            ...
                            <ul class="myPages">
                                <div class="row">
                                    ...
                                    <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                        <div class="product__thumb">
                                            <a class="first__img"href="<%=Util.fullPath("Chitietsanpham1?id="+p1.getInt(1))%>"><img src="<%=p1.getString(4)%>"></a>
                                        ...
                                        <div class="product__content content--center content--center">
                                            <h4><a href="<%=Util.fullPath("Chitietsanpham1?id="+p1.getInt(1))%>"><%=p1.getString(2)%></a></h4>
                                            <ul class="prize d-flex">
                                                <li><%=p1.getString(3)%> ₫</li>
                                                <%--											<li class="old_prize">115.000 ₫</li>--%>
                                            </ul>
                                            <div class="action">
                                                <div class="actions_inner">
                                                    <ul class="add_to_links">
                                                        <li><a class="cart" href="<%=Util.fullPath("ShowCart")%>" title="Giỏ hàng"><i class="bi bi-shopping-bag4"></i></a></li>
                                                        <li><a class="wishlist" href="<%= Util.fullPath("AddNXB?id="+p1.getInt(1))%>" title="Thêm vào giỏ hàng"><i class="bi bi-shopping-cart-full"></i></a></li>
                                                        <li><a data-toggle="modal" title="Xem nhanh" class="quickview modal-view detail-link" href="#productmodal"><i class="bi bi-search"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <ul class="myPages">
                                <div class="row">
                                    ...
                                    <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                        <div class="product__thumb">
                                            <a class="first__img"href="<%=Util.fullPath("Chitietsanpham2?id="+p2.getInt(1))%>"><img src="<%=p2.getString(4)%>"></a>
                                            <!--											<a class="second__img animation1" href="single-product.jsp"><img src="images/books/8.jpg" alt="product image"></a>-->
                                            <%--										<div class="hot__box">--%>
                                            <%--											<span class="hot-label">BEST SALER</span>--%>
                                            <%--										</div>--%>
                                        ...
                                        <div class="product__content content--center content--center">
                                            ...
                                            <div class="action">
                                                <div class="actions_inner">
                                                    <ul class="add_to_links">
                                                        <li><a class="cart" href="<%=Util.fullPath("ShowCart")%>" title="Giỏ hàng"><i class="bi bi-shopping-bag4"></i></a></li>
                                                        <li><a class="wishlist" href="<%= Util.fullPath("AddNXB?id="+p2.getInt(1))%>" title="Thêm vào giỏ hàng"><i class="bi bi-shopping-cart-full"></i></a></li>
                                                        <li><a data-toggle="modal" title="Xem nhanh" class="quickview modal-view detail-link" href="#productmodal"><i class="bi bi-search"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                            ...
                            <div class="pagination">
                                <a id="pre" onclick="plusPag(-1)" title="Trước"><i class="fas fa-chevron-left"></i></a>
                                <a class="actived" onclick="currentPag(1)" title="1">1</a>
                                <a  class="actived"  onclick="currentPag(2)"  title="2">2</a>
                                <a  class="actived" onclick="currentPag(3)"  title="3">3</a>
                                <a id="next" onclick="plusPag(1)" title="Sau"><i class="fas fa-chevron-right"></i></a>
                        ...
                        <div class="shop-grid tab-pane fade" id="nav-list" role="tabpanel">
                                    ...
                                    <div class="list__view">
                                        ...
                                        <div class="content">
                                            ...
                                            <ul class="prize__box">
                                                ...
                                                <%--	        									<li class="old__prize">79.000 ₫</li>--%>
                                            </ul>
                                            <p class="gioitheu" style="text-align: justify"><%=p3.getString(5)%></p>
                                            <ul class="cart__action d-flex">
                                                <li class="cart"><a href="<%= Util.fullPath("AddNXB?id="+p3.getInt(1))%>">Thêm vào giỏ hàng</a></li>
                            ...
                            <ul class="myPages1">
                                <%
                                    ResultSet p4 = (ResultSet) request.getAttribute("p4");
                                    while (p4.next()){
                                ...
                                <div class="list__view mt--40">
                                    ...
                                    <div class="thumb">
                                        <a class="first__img" href="<%=Util.fullPath("Chitietsanpham4?id="+p4.getInt(1))%>"><img src="<%=p4.getString(4)%>"></a>
                                        <!--	        								<a class="second__img animation1" href="single-product.jsp"><img src="images/product/9.jpg" alt="product images"></a>-->
                                    </div>
                                    <div class="content">
                                        <h2><a href="<%=Util.fullPath("Chitietsanpham4?id="+p4.getInt(1))%>"><%=p4.getString(2)%></a></h2>
                                        <ul class="rating d-flex">
                                            <li class="on"><i class="zmdi zmdi-star "></i></li>
                                            <li class="on"><i class="zmdi zmdi-star "></i></li>
                                            <li class="on"><i class="zmdi zmdi-star "></i></li>
                                        ...
                                        <ul class="prize__box">
                                            <li><%=p4.getString(3)%> ₫</li>

                                        </ul>
                                        <p class="gioithieu" style="text-align: justify"><%=p4.getString(5)%>
                                        </p>
                                        <ul class="cart__action d-flex">
                                            <li class="cart"><a href="<%= Util.fullPath("AddNXB?id="+p4.getInt(1))%>">Thêm vào giỏ hàng</a></li>
                                            <!--	        									<li class="wishlist"><a href="cart.jsp"></a></li>-->
                            ...
                            <ul class="myPages1">
                                ...
                                <div class="list__view mt--40">
                                    ...
                                    <div class="thumb">
                                        <a class="first__img" href="<%=Util.fullPath("Chitietsanpham5?id="+p5.getInt(1))%>"><img src="<%=p5.getString(4)%>"></a>
                                        <!--	        								<a class="second__img animation1" href="single-product.jsp"><img src="images/product/9.jpg" alt="product images"></a>-->
                                    </div>
                                    <div class="content">
                                        <h2><a href="<%=Util.fullPath("Chitietsanpham5?id="+p5.getInt(1))%>"><%=p5.getString(2)%></a></h2>
                                        <ul class="rating d-flex">
                                            <li class="on"><i class="zmdi zmdi-star "></i></li>
                                            <li class="on"><i class="zmdi zmdi-star "></i></li>
                                            <li class="on"><i class="zmdi zmdi-star "></i></li>
                                        ...
                                        <ul class="prize__box">
                                            <li><%=p5.getString(3)%> ₫</li>

                                        </ul>
                                        <p class="gioithieu" style="text-align: justify"><%=p5.getString(5)%>
                                        </p>
                                        <ul class="cart__action d-flex">
                                            <li class="cart"><a href="<%= Util.fullPath("AddNXB?id="+p5.getInt(1))%>">Thêm vào giỏ hàng</a></li>
                                            <!--	        									<li class="wishlist"><a href="cart.jsp"></a></li>-->
                            ...
                            <div class="pagination">
                                ...
                                <a class="actived1" onclick="currentPag1(2)" title="2">2</a>
                                <a class="actived1" onclick="currentPag1(3)"  title="3">3</a>
                                <a id="next1" onclick="plusPag1(1)" title="Sau"><i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
