...
<div class = "container-fluid padding0">
    ...
    <div id = "main">
        ...
        <h1><span class = "glyphicon glyphicon-folder-open addtop" aria-hidden = "true"></span>&nbsp;&nbsp;Thêm nhà xuất bản</h1>
        <div id = "sub-main">
            <div class = "row">
            ...
            <div class = "row margin0 space-top">
                <div class = "option-h4 text-justify">
                    <form action="<%=Util.fullPath("Themnhaxuatban")%>" method="post">
                    <h4>Thêm nhà xuất bản</h4>
                    <form>
                        <p style="color: red"><%=err%>
                        <div class = "madm">
                            <label>STT</label><br>
                            <input type = "text" class = "texttendm" name="id" id="madanhmuc" placeholder = " Nhập mã nhà xuất bản cần thêm">

                        </div>
                        <div class = "tendm">
                            <label>Tên nhà xuất bản</label><br>
                            <input type = "text" class = "texttendm" name="name" id="tendanhmuc" placeholder = " Nhập tên nhà xuất bản cần thêm">

                        </div>
                        <div class = "tendm">
                            <label>Active</label><br>
                            <input type = "text" class = "texttendm" placeholder = " " name="active">
