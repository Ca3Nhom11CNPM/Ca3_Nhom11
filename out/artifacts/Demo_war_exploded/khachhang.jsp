	...
	<body>
		<div class = "container-fluid padding0">
			...
			<div id = "main">
				...
				<h1><i class="fas fa-heartbeat" style="font-size: 17px"></i>  Khách hàng</h1>
				<div id = "sub-main">
					<div class = "row">
					...
					<div class = "row space-top box-total">
						<div class = "col-xs-12 col-sm-8 col-md-7 col-lg-6">
							<span><i>Tổng số khách hàng: </i><strong>10</strong> |</span>
...
<%--										<th>Mã khách hàng</th>--%>
								...
								<tr>
									...
									<td>
										<a onclick="return confirm('Bạn có chắc chắn muốn xóa')" title="Xoá"  href = "<%=Util.fullPath("Xoakhachhang?maTK="+rs1.getInt(1))%>"><i class="fas fa-trash-alt" style="font-size: 20px; color: #03A9F4"></i></a>
									</td>
								</tr>
								<% } %>
							</table>
