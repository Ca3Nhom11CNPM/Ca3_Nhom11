...
<%@ page import="vn.edu.nlu.fit.Admin.Danhmuc" %>
<%@ page import="vn.edu.nlu.fit.Admin.ThemdanhmucIMP" %>
...
<div class = "container-fluid padding0">
	...
	<div id = "main">
		...
		<h1><i class="fas fa-folder-open"></i> Danh mục sản phẩm</h1>
		<div id = "sub-main">
...
<%--							<td><%=rs1.getInt(3)%></td>--%>
							<td>
								<a href = "<%=Util.fullPath("Chitietdanhmuc?id="+rs1.getInt(1))%>"><i class="far fa-edit" style="font-size: 20px; color: #03A9F4 "></i>   </a>
								<a onclick="return confirm('Bạn có chắc chắn muốn xóa')" title="Xoá" href = "<%=Util.fullPath("Xoadanhmuc?id="+rs1.getInt(1))%>" ><i class="fas fa-trash-alt" style="font-size: 20px; color: #03A9F4"></i></a>
