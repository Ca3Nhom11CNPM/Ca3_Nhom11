...
<div class = "container-fluid padding0">
    ...
    <div id = "main">
        ...
        <h1><span class = "glyphicon glyphicon-folder-open addtop" aria-hidden = "true"></span>&nbsp;  Sửa nhà xuất bản</h1>
        <div id = "sub-main">
            <div class = "row">
                <div class = "col-xs-12 col-sm-7 col-md-8 col-lg-9">
                    <ol class = "breadcrumb">
                        ...
                        <li class = "active">Sửa nhà xuất bản</li>
                    </ol>
                </div>
            ...
            <div class = "row margin0 space-top">
                <div class = "option-h4 text-justify">
                    <form action="<%=Util.fullPath("UpdateNXB")%>" method="post">
                    ...
                    <form>
                        <div class = "madm">
                            <label>Ma nha xuat ban</label><br>
                        ...
                        <div class = "tendm">
                            ...
                            <input type = "text" class = "texttendm"  value="<%=rs.getInt(3)%>" name="active">
