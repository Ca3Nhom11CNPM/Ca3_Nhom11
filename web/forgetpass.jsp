...
<div class="wrapper" id="wrapper">
    ...
    <div class="maincontent bg--white pt--80 pb--55">
        <div class="login_dn">
            <p class="text_dn">Quên mật khẩu</p>
            <form action="ForgetPasswordServlet" method="post">
            <div class="row_tk">
                <p class="forget">Email: </p>
                <input type="email" class="text_forget" id="forget" placeholder="  Nhập email" name="emailPassword">
            </div>
            <button type="button" class="send" id="gui">Gửi</button>
            </form>
        </div>
    </div>
