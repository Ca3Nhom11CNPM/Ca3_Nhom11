...
<%--                            <span class="brd-separetor">/</span>--%>
    ...
    <div class="maincontent bg--white pt--80 pb--55">
        <div class="container">
            <%
                ResultSet p1 = (ResultSet) request.getAttribute("ps");
                while (p1.next()){ %>
            <div class="row">
                    ...
                    <div class="wn__related__product pt--80 pb--50">
                        ...
                        <div class="row mt--60">
                            <div class="productcategory__slide--2 arrows_style owl-carousel owl-theme">
                                <%
                                    ResultSet p2 = (ResultSet) request.getAttribute("p3");
                                    while (p2.next()){

                                %>
                                <div class="product product__style--3 col-lg-4 col-md-4 col-sm-6 col-12">
                                    <div class="product__thumb">
                                        <a class="first__img" href="<%=Util.fullPath("Chitietsanpham2?id="+p2.getInt(1))%>"><img src="<%=p2.getString(4)%>" height="340" width="230"/></a>
                                    ...
                                    <div class="product__content content--center">
                                        <h4><a href="<%=Util.fullPath("Chitietsanpham2?id="+p2.getInt(1))%>"><%=p2.getString(2)%></a></h4>
