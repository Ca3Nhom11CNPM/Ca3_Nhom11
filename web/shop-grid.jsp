...
<%--											<li class="old_prize">115.000 ₫</li>--%>
										...
										<div class="action">
											<div class="actions_inner">
												<ul class="add_to_links">
													<li><a class="cart" href="<%=Util.fullPath("ShowCart")%>" title="Giỏ hàng"><i class="bi bi-shopping-bag4"></i></a></li>
													<li><a class="wishlist" href="<%= Util.fullPath("AddCart?id="+p1.getInt(1))%>" title="Thêm vào giỏ hàng"><i class="bi bi-shopping-cart-full"></i></a></li>
													<li><a data-toggle="modal" title="Xem nhanh" class="quickview modal-view detail-link" href="#productmodal"><i class="bi bi-search"></i></a></li>
												</ul>
											</div>
										</div>
                                            ...
                                            <div class="product__content content--center content--center">
                                                ...
                                                <div class="action">
                                                    <div class="actions_inner">
                                                        <ul class="add_to_links">
                                                            <li><a class="cart" href="<%=Util.fullPath("ShowCart")%>" title="Giỏ hàng"><i class="bi bi-shopping-bag4"></i></a></li>
                                                            <li><a class="wishlist" href="<%= Util.fullPath("AddCart?id="+p2.getInt(1))%>" title="Thêm vào giỏ hàng"><i class="bi bi-shopping-cart-full"></i></a></li>
                                                            <li><a data-toggle="modal" title="Xem nhanh" class="quickview modal-view detail-link" href="#productmodal"><i class="bi bi-search"></i></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
...
<!--	        									<li class="wishlist"><a href="cart.jsp"></a></li>-->
								...
								<ul class="myPages1">
									...
									<div class="content">
										...
										<ul class="cart__action d-flex">
											<li class="cart"><a href="<%= Util.fullPath("AddCart?id="+p4.getInt(1))%>">Thêm vào giỏ hàng</a></li>
											<!--	        									<li class="wishlist"><a href="cart.jsp"></a></li>-->
								...
								<ul class="myPages1">
									...
									<div class="list__view mt--40">
										...
										<div class="content">
											...
											<ul class="cart__action d-flex">
												<li class="cart"><a href="<%= Util.fullPath("AddCart?id="+p5.getInt(1))%>">Thêm vào giỏ hàng</a></li>
												<!--	        									<li class="wishlist"><a href="cart.jsp"></a></li>-->
