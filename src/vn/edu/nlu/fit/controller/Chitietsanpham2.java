...
@WebServlet("/Chitietsanpham2")
public class Chitietsanpham2 extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            ResultSet ps= s2.executeQuery(sql);
            ...
            ResultSet p3= s5.executeQuery(sql);
            request.setAttribute("p3",p3);

            request.getRequestDispatcher("slide3.jsp").forward(request,response);
